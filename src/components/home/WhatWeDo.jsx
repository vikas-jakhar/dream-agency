        ...
        <div className='relative pt-20 sm:pt-24'>
            <div className="max-w-[1920px] mx-auto w-full relative lg:pt-24 mt-1.5">
                ...
                <div className="flex items-center w-fit gap-3.5 mx-auto mt-5 relative z-10 lg:absolute lg:bottom-24 lg:!ml-5 lg:left-[calc((100vw-1024px)/2)] xl:left-[calc((100vw-1340px)/2+90px)]">
                    <Icon iconName='arrow' className='prevButton w-[35px] h-[34px] rounded-full justify-center items-center opacity-[33%] rotate-180 border-2 border-black' />
                    <Icon iconName='arrow' className='nextButton w-[35px] h-[34px] rounded-full justify-center items-center border-2 border-black' />
                </div>
                        ...
                        {WHAT_WE_DO_DATA_LIST.map((items, index) => (
                            <SwiperSlide key={index}>
                                <div className="w-full h-full min-h-[192px] shadow-3xl bg-white p-[18px] rounded-[10px]">
                                    ...
                                    <p className='text-off-black opacity-65 font-light tracking-[0.02em] text-custom-xl leading-5'>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                                </div>
                            </SwiperSlide>
                        ))}
                    </Swiper>
